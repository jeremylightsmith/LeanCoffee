...
/**
 * This is Tweet This v1.8.2, build 036, released 2011-02-21.
 */
...
function tweet_this_footer() {
	...
	printf(__('Twitter links powered by <a target="_blank" href="http://' .
		...
		'</a>, a <a href="http://www.amazon.com/exec/obidos/' .
		'redirect-home/brilliaphotog-20">WordPress</a> plugin for ' .
		'<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick' .
		'&amp;business=richardxthripp@thripp.com&amp;currency_code=' .
		'USD&amp;amount=&amp;return=&amp;item_name=Donations+for+' .
		'Tweet+This+plugin">Twitter</a>.', 'tweet-this'),
...
function tweet_this_ad_body($content) {
	if(is_singular()) return $content .= '<p><a href=' .
	'"http://www.amazon.com/exec/obidos/redirect-home/' .
	'brilliaphotog-20"><img src="http://gov.thripp.com/revenue/' .
	'amazon-338x280.jpg" alt="Amazon.com" /></a></p>';
	else return $content;
}
...
function tweet_this_ad_footer() {
	echo	'<div style="width:738px;margin:auto;"><p><a href=' .
	'"http://www.amazon.com/exec/obidos/redirect-home/' .
	'brilliaphotog-20"><img src="http://gov.thripp.com/revenue/' .
	'amazon-728x90.jpg" alt="Tweet This affiliate link" /></a>' .
	'</p></div>';
}
